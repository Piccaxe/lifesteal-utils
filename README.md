...
| **Hotbar editor** | A visual screen to reorder your hotbar — click two slots to swap them. Real inventory swaps (synced to the server). Open with the keybind or `/piccaxeutils hotbar`. |
