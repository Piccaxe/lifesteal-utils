...
public class TuningScreen extends Screen {
	...
	private static final List<Toggle> TOGGLES = List.of(
		...
		new Toggle("Health: screen list", c -> c.healthBarList, (c, v) -> c.healthBarList = v),
		new Toggle("Health: over heads", c -> c.healthBarOverhead, (c, v) -> c.healthBarOverhead = v),
		new Toggle("Health: heart icons", c -> c.healthBarHearts, (c, v) -> c.healthBarHearts = v),
